/** UI-only country dial codes for auth phone picker (no backend coupling). */
...
export const COUNTRY_DIAL_CODES: CountryDialCode[] = [
  ...
  { iso2: 'AG', name: 'Antigua and Barbuda', dialCode: '1', flag: '🇦🇬' },
  ...
  { iso2: 'CW', name: 'Curacao', dialCode: '599', flag: '🇨🇼' },
  ...
  { iso2: 'MO', name: 'Macau', dialCode: '853', flag: '🇲🇴' },
  ...
  { iso2: 'RE', name: 'Reunion', dialCode: '262', flag: '🇷🇪' },
  { iso2: 'RO', name: 'Romania', dialCode: '40', flag: '🇷🇴' },
  { iso2: 'RU', name: 'Russia', dialCode: '7', flag: '🇷🇺' },
  { iso2: 'RW', name: 'Rwanda', dialCode: '250', flag: '🇷🇼' },
  { iso2: 'BL', name: 'Saint Barthelemy', dialCode: '590', flag: '🇧🇱' },
  { iso2: 'SH', name: 'Saint Helena', dialCode: '290', flag: '🇸🇭' },
  { iso2: 'KN', name: 'Saint Kitts and Nevis', dialCode: '1', flag: '🇰🇳' },
  { iso2: 'LC', name: 'Saint Lucia', dialCode: '1', flag: '🇱🇨' },
  { iso2: 'MF', name: 'Saint Martin', dialCode: '590', flag: '🇲🇫' },
  { iso2: 'PM', name: 'Saint Pierre and Miquelon', dialCode: '508', flag: '🇵🇲' },
  { iso2: 'VC', name: 'Saint Vincent and the Grenadines', dialCode: '1', flag: '🇻🇨' },
  ...
  { iso2: 'SJ', name: 'Svalbard and Jan Mayen', dialCode: '47', flag: '🇸🇯' },
  ...
  { iso2: 'WF', name: 'Wallis and Futuna', dialCode: '681', flag: '🇼🇫' },
...
export function findCountryByIso2(
  ...
  return COUNTRY_DIAL_CODES.find((c) => c.iso2 === key);
}
...
export function findCountryByDialCode(
  ...
  return COUNTRY_DIAL_CODES.find((c) => c.dialCode === digits);
}
